...
class ExchangeRateDataApi {
  ...
  Future<dynamic> getRate(String baseCode) async {
    final response =
        await http.get(Uri.parse('$baseUrl$_key/latest/$baseCode'));
    ...
    final Map<String, dynamic> json = response.statusCode == 200
        ? jsonDecode(response.body)["conversion_rates"] as Map<String, dynamic>
